...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    /**
     * Id для идентификации разрешения на запрос READ_CONTACTS
     */
    private static final int REQUEST_READ_CONTACTS = 0;

    /**
     * Пробные логин/пароль
    ...
    /**
     * Отслеживать задачу входа для возможности её прерывания
     */
     ...
     * Если не получается, появляются сообщения об ошибке.
     */
    private void attemptLogin() {
        ...
        // Сохраняем значения (логин/пароль) пока пытаемся войти.
        ...
        if (cancel) {
            // При ошибке не пытаемся входить и фокусируемся на поле в котором первым возникла ошибка.
            focusView.requestFocus();
        } else {
            // Показываем ProgressBar и запускаем задачу входа.
            showProgress(true);
    ...
    /**
     * Показываем прогресс, прячем форму входа.
     */
